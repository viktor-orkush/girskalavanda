...
function glav_noindex_mphb_booking_pages( $robots ) {
    ...
    $booking_slugs = [
        ...
        'customer-cabinet', 'booking', 'checkout', 'accommodation',
    ];
      ...
      <div class="gl-container">
        <div class="gl-contacts__grid">
          <div class="gl-contacts__info gl-animate">
            ...
            <p class="gl-contacts__subtitle">Ми знаходимось у мальовничому містечку Східниця. Будемо раді вас прийняти!</p>
