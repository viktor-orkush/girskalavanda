...
function glav_seo_document_title_parts( $title ) {
    ...
    if ( is_front_page() || is_page_template( 'page-home.php' ) ) {
        $title['title'] = 'Комплекс Гірська Лаванда | Відпочинок у Східниці: Апартаменти, Баня, Чан';
        unset( $title['tagline'], $title['site'] );
    } elseif ( is_page( 'banya' ) ) {
        $title['title'] = 'Баня на дровах у Східниці | Гірська Лаванда';
        unset( $title['site'] );
    } elseif ( is_page( 'chan' ) ) {
        $title['title'] = 'Гарячий чан у Східниці | Оздоровлення та відпочинок';
        unset( $title['site'] );
    } elseif ( is_page( 'rooms' ) ) {
        $title['title'] = 'Апартаменти в Східниці | Оренда номерів у Гірській Лавані';
        unset( $title['site'] );
...
function glav_seo_get_description() {
    ...
    if ( is_front_page() || is_page_template( 'page-home.php' ) ) {
        return 'Комплекс Гірська Лаванда в Східниці — відпочинок та апартаменти в оренду в Карпатах, баня на дровах у Східниці та гарячий чан. Бронювання онлайн.';
    }
    if ( is_page( 'banya' ) || is_page( 'chan' ) ) {
        return 'Приватна баня на дровах у Східниці — парна, хамам, міні-басейн. Від 2 500 ₴/сеанс. Бронювання онлайн.';
    }
    if ( is_page( 'rooms' ) ) {
    ...
    if ( is_singular( 'mphb_room_type' ) ) {
        ...
        return 'Забронюйте ' . mb_strtolower( get_the_title() ) . ' у комплексі Гірська Лаванда (Східниця). ' . $details . 'Відпочинок у Східниці з традиційною банею та гарячим чаном.';
    }
...
function glav_schema_lodging_business() {
    ...
    $schema = [
        ...
        'description'   => 'Заміський комплекс у серці Карпат в Східниці. Проживання, баня на дровах, гарячий чан серед природи.',
        'url'           => home_url( '/' ),
        'address'       => [
            '@type'           => 'PostalAddress',
